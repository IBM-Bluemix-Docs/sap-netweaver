...
<table>
 ...
 <tr>
   ...
   <td>Install SAP NetWeaver on your IBM Cloud infrastructure the same as if the servers were on-premises. For more information about installing SAP NetWeaver, see <a href="sap-installing-SAP-landscape.html#install_sap">Downloading and installing SAP software and applications</a> for more information.</td>
   </td>
   </tr>
   </TBODY>
   </table>
